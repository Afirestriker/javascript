...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["jquery"], e)
    : (t.initFontIconPickerNode = e(t.jQuery));
})(this, function (t) {
  "use strict";
  function e(t) {
    return (e =
  ...
  function r(t, e) {
    (this.element = n(t)),
      ...
      (this.iconPicker = n("<div/>", {
        class: "icons-selector",
        style: "position: relative",
        html: this._getPickerTemplate(),
        attr: { "data-fip-origin": this.element.attr("id") },
      })),
      ...
      (this.open = !1),
      (this.guid = o++),
      (this.eventNameSpace = ".fontIconPicker".concat(o)),
      (this.searchValues = []),
  ...
  function c(t) {
    return !(
      !(e = t).fn ||
      ((!e.fn || !e.fn.fontIconPicker) &&
        ((e.fn.fontIconPicker = function (t) {
          var i = this;
          return (
            this.each(function () {
              e.data(this, "fontIconPicker") ||
                e.data(this, "fontIconPicker", new r(this, t));
            }),
            ...
            (this.destroyPicker = function () {
              i.each(function () {
                e.data(this, "fontIconPicker") &&
                  (e.data(this, "fontIconPicker").destroy(),
                  e.removeData(this, "fontIconPicker"));
              });
            }),
            (this.refreshPicker = function (s) {
              s || (s = t),
                ...
                i.each(function () {
                  e.data(this, "fontIconPicker") ||
                    e.data(this, "fontIconPicker", new r(this, s));
                });
            }),
  ...
  (r.prototype = {
    init: function () {
      ...
      this.iconPicker.css({ left: "" }),
        ...
        this.element.is("select") || (this.triggerEvent = "input"),
    ...
    setIcons: function (t, e) {
      (this.settings.source = Array.isArray(t) ? i(t) : n.extend({}, t)),
        (this.settings.searchSource = Array.isArray(e)
          ? i(e)
          : n.extend({}, e)),
        this._initSourceIndex(),
        this._loadCategories(),
    ...
    destroy: function () {
      this.iconPicker.off().remove(),
        ...
        n(window).off("resize" + this.eventNameSpace),
        n("html").off("click" + this.eventNameSpace);
    },
    ...
    _initAutoClose: function () {
      ...
      this.settings.autoClose &&
        n("html").on("click" + this.eventNameSpace, function (e) {
          var i = e.target;
          t.selectorPopup.has(i).length ||
            t.selectorPopup.is(i) ||
            t.iconPicker.has(i).length ||
            t.iconPicker.is(i) ||
            (t.open && t._toggleIconSelector());
        });
    },
    ...
    _initIconSearch: function () {
      ...
      this.selectorPopup.on("input", ".icons-search-input", function (e) {
        ...
        "" !== i
          ? (t.searchIcon.removeClass("fip-icon-search"),
            t.searchIcon.addClass("fip-icon-cancel"),
            (t.isSearch = !0),
            (t.currentPage = 1),
            (t.iconsSearched = []),
            n.grep(t.searchValues, function (e, s) {
              if (0 <= e.toLowerCase().search(i.toLowerCase()))
                return (
                  (t.iconsSearched[t.iconsSearched.length] =
                    t.settings.source[s]),
                  !0
                );
            }),
            t._renderIconContainer())
          : t._resetSearch();
      }),
        this.selectorPopup.on(
          "click",
          ".selector-search .fip-icon-cancel",
          function () {
            t.selectorPopup.find(".icons-search-input").focus(),
              t._resetSearch();
          }
        );
    },
    _initPagination: function () {
      ...
      this.selectorPopup.on("click", ".selector-arrow-right", function (e) {
        t.currentPage < t.totalPage &&
          ((t.currentPage = t.currentPage + 1), t._renderIconContainer());
      }),
      ...
      this.selectorPopup.on(
        ...
        function (e) {
          ...
          var i = n(e.currentTarget),
            s = i.val();
          if ("all" === i.val())
            (t.settings.source = t.backupSource),
              (t.searchValues = t.backupSearch);
          else {
            var o = parseInt(s, 10);
            t.availableCategories[o] &&
              ((t.settings.source = t.availableCategories[o]),
              (t.searchValues = t.availableCategoriesSearch[o]));
          }
    ...
    _getPickerTemplate: function () {
      return '\n<div class="selector" data-fip-origin="'
        .concat(
          this.element.attr("id"),
          '">\n\t<span class="selected-icon">\n\t\t<i class="fip-icon-block"></i>\n\t</span>\n\t<span class="selector-button">\n\t\t<i class="fip-icon-down-dir"></i>\n\t</span>\n</div>\n<div class="selector-popup-wrap" data-fip-origin="'
        )
        .concat(
          this.element.attr("id"),
        ...
        .concat(
          this.settings.hasSearch
            ? '<div class="selector-search">\n\t\t\t<input type="text" name="" value="" placeholder="'.concat(
      ...
      if ("object" === e(this.settings.source)) {
        if (Array.isArray(this.settings.source))
          (this.isCategorized = !1),
            ...
            (this.settings.source = n.map(
              this.settings.source,
              function (t, e) {
                return "function" == typeof t.toString ? t.toString() : t;
              }
            )),
            Array.isArray(this.settings.searchSource)
              ? (this.searchValues = n.map(
          ...
          for (var i in ((this.settings.source = []),
          (this.searchValues = []),
          (this.availableCategoriesSearch = []),
          (this.selectedCategory = !1),
          (this.availableCategories = []),
          ...
          t)) {
            var s = this.availableCategories.length,
              o = n("<option />");
            for (var r in (o.attr("value", s),
            o.html(i),
            this.selectCategory.append(o),
            ...
            t[i])) {
              var c = t[i][r],
                a =
                  ...
                  this.settings.searchSource[i][r]
                    ? this.settings.searchSource[i][r]
                    : c;
              "function" == typeof c.toString && (c = c.toString()),
                c &&
                  c !== this.settings.emptyIconValue &&
                  (this.settings.source.push(c),
                  this.availableCategories[s].push(c),
                  this.searchValues.push(a),
                  this.availableCategoriesSearch[s].push(a));
            }
          }
        }
    ...
    _populateSourceFromSelect: function () {
      ...
      (this.settings.source = []),
        ...
        this.element.find("optgroup").length
          ? ((this.isCategorized = !0),
            this.element.find("optgroup").each(function (e, i) {
              var s = t.availableCategories.length,
                o = n("<option />");
              o.attr("value", s),
                o.html(n(i).attr("label")),
                t.selectCategory.append(o),
                (t.availableCategories[s] = []),
                (t.availableCategoriesSearch[s] = []),
                n(i)
                  .find("option")
                  .each(function (e, i) {
                    var o = n(i).val(),
                      r = n(i).html();
                    o &&
                      o !== t.settings.emptyIconValue &&
                      (t.settings.source.push(o),
                      t.availableCategories[s].push(o),
                      t.searchValues.push(r),
                      t.availableCategoriesSearch[s].push(r));
                  });
            }),
            this.element.find("> option").length &&
              this.element.find("> option").each(function (e, i) {
                ...
                null === t.unCategorizedKey &&
                  ((t.unCategorizedKey = t.availableCategories.length),
                  (t.availableCategories[t.unCategorizedKey] = []),
                  (t.availableCategoriesSearch[t.unCategorizedKey] = []),
                  n("<option />")
                    .attr("value", t.unCategorizedKey)
                    .html(t.settings.unCategorizedText)
                    .appendTo(t.selectCategory)),
                  t.settings.source.push(s),
                  t.availableCategories[t.unCategorizedKey].push(s),
                  t.searchValues.push(o),
                  t.availableCategoriesSearch[t.unCategorizedKey].push(o);
              }))
          : this.element.find("option").each(function (e, i) {
              var s = n(i).val(),
                o = n(i).html();
    ...
    _loadIcons: function () {
      this.iconContainer.html(
        ...
        Array.isArray(this.settings.source) && this._renderIconContainer();
    },
    _iconGenerator: function (t) {
      return "function" == typeof this.settings.iconGenerator
        ? this.settings.iconGenerator(t)
        : "<i " +
    ...
    _renderIconContainer: function () {
      ...
      if (
        ...
        (t = (this.currentPage - 1) * this.settings.iconsPerPage),
        this.settings.emptyIcon)
      )
        this.iconContainer.html(
          '<span class="fip-box" data-fip-value="fip-icon-block"><i class="fip-icon-block"></i></span>'
        );
      else {
        if (1 > i.length)
          return void this.iconContainer.html(
            '<span class="icons-picker-error" data-fip-value="fip-icon-block"><i class="fip-icon-block"></i></span>'
          );
        this.iconContainer.html("");
      }
      ...
      if (
        this.settings.emptyIcon ||
        (this.element.val() &&
          -1 !== n.inArray(this.element.val(), this.settings.source))
      )
        if (-1 === n.inArray(this.element.val(), this.settings.source))
          this._setSelectedIcon("");
        else {
          var c = this.element.val();
          c === this.settings.emptyIconValue && (c = "fip-icon-block"),
            this._setSelectedIcon(c);
        }
    ...
    _setSelectedIcon: function (t) {
      ...
      "" === t
        ? e.html('<i class="fip-icon-block"></i>')
        : e.html(this._iconGenerator(t));
      var i = this.element.val();
      this.element.val("" === t ? this.settings.emptyIconValue : t),
        i !== t &&
    ...
    _repositionIconSelector: function () {
      var t = this.iconPicker.offset(),
        ...
        i = t.left;
      this.selectorPopup.css({ left: i, top: e });
    },
    _fixWindowOverflow: function () {
      ...
      var e = this.selectorPopup.outerWidth(),
        ...
        o =
          "self" == this.settings.appendTo
            ? this.selectorPopup.parent().offset()
            : n(this.settings.appendTo).offset();
      if (
        (t || this.selectorPopup.find(".selector-popup").hide(), s + e > i - 20)
      ) {
        var r =
            this.selectorButton.offset().left +
            this.selectorButton.outerWidth(),
          c = Math.floor(r - e - 1);
        0 > c
          ? this.selectorPopup.css({ left: i - 20 - e - o.left })
          : this.selectorPopup.css({ left: c });
      }
    },
    _fixOnResize: function () {
      "self" !== this.settings.appendTo && this._repositionIconSelector(),
    ...
    _toggleIconSelector: function () {
      (this.open = this.open ? 0 : 1),
        this.open &&
          ...
          this._fixWindowOverflow()),
        this.selectorPopup.find(".selector-popup").slideToggle(
          300,
          n.proxy(function () {
            this.iconPicker
